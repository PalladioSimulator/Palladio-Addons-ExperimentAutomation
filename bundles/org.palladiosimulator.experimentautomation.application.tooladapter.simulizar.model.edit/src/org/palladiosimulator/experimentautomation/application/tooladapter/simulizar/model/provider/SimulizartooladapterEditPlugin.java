...
/**
 * This is the central singleton for the Simulizartooladapter edit plugin. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public final class SimulizartooladapterEditPlugin extends EMFPlugin {
    /**
     * Keep track of the singleton. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public static final SimulizartooladapterEditPlugin INSTANCE = new SimulizartooladapterEditPlugin();
     ...
     * @generated
     */
    public SimulizartooladapterEditPlugin() {
        super(new ResourceLocator[] { EDP2EditPlugin.INSTANCE, ExperimentAutomationEditPlugin.INSTANCE,
                ...
                MonitorrepositoryEditPlugin.INSTANCE, ProbabilityFunctionEditPlugin.INSTANCE, StoexEditPlugin.INSTANCE,
                UnitsEditPlugin.INSTANCE, ServiceLevelObjectiveEditPlugin.INSTANCE, UsageevolutionEditPlugin.INSTANCE,
                DlimEditPlugin.INSTANCE, EcoreEditPlugin.INSTANCE, });
    }
