...
public class EDP2DatasourceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public EDP2DatasourceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_EDP2Datasource_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_EDP2Datasource_id_feature",
	...
	public String getText(Object object) {
		String label = ((EDP2Datasource) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_EDP2Datasource_type")
