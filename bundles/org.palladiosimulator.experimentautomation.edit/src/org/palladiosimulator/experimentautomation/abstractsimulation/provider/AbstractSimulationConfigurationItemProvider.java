...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.experimentautomation.abstractsimulation.AbstractSimulationConfiguration} object.
...
public class AbstractSimulationConfigurationItemProvider extends ToolConfigurationItemProvider {
	...
	protected void addSimulateFailuresPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AbstractSimulationConfiguration_simulateFailures_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_AbstractSimulationConfiguration_simulateFailures_feature",
								"_UI_AbstractSimulationConfiguration_type"),
						AbstractsimulationPackage.Literals.ABSTRACT_SIMULATION_CONFIGURATION__SIMULATE_FAILURES, true,
						false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AbstractsimulationPackage.Literals.ABSTRACT_SIMULATION_CONFIGURATION__DATASOURCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(AbstractsimulationPackage.Literals.ABSTRACT_SIMULATION_CONFIGURATION__DATASOURCE,
