...
public class RandomNumberGeneratorSeedItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addSeed0PropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_RandomNumberGeneratorSeed_seed0_feature",
    ...
    protected void addSeed1PropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_RandomNumberGeneratorSeed_seed1_feature",
                        "_UI_RandomNumberGeneratorSeed_type"),
    ...
    protected void addSeed2PropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_RandomNumberGeneratorSeed_seed2_feature",
                        "_UI_RandomNumberGeneratorSeed_type"),
    ...
    protected void addSeed3PropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_RandomNumberGeneratorSeed_seed3_feature",
                        "_UI_RandomNumberGeneratorSeed_type"),
    ...
    protected void addSeed4PropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_RandomNumberGeneratorSeed_seed4_feature",
                        "_UI_RandomNumberGeneratorSeed_type"),
    ...
    protected void addSeed5PropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_RandomNumberGeneratorSeed_seed5_feature",
                        "_UI_RandomNumberGeneratorSeed_type"),
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator()
            .getImage("full/obj16/RandomNumberGeneratorSeed"));
    }
