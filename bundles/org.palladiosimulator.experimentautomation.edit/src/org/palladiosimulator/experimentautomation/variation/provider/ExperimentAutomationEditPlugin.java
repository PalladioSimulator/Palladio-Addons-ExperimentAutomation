...
public final class ExperimentAutomationEditPlugin extends EMFPlugin {
	...
	public ExperimentAutomationEditPlugin() {
		super(new ResourceLocator[] { DlimEditPlugin.INSTANCE, EcoreEditPlugin.INSTANCE, EDP2EditPlugin.INSTANCE,
				...
				ScalingPolicyDefinitionEditPlugin.INSTANCE, SemanticEditPlugin.INSTANCE,
