...
public class InitialModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addScalingDefinitionsPropertyDescriptor(object);
			addSpdSemanticConfigurationPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Scaling Definitions feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addScalingDefinitionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_InitialModel_scalingDefinitions_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_InitialModel_scalingDefinitions_feature",
						"_UI_InitialModel_type"),
				ExperimentsPackage.Literals.INITIAL_MODEL__SCALING_DEFINITIONS, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Spd Semantic Configuration feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSpdSemanticConfigurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_InitialModel_spdSemanticConfiguration_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_InitialModel_spdSemanticConfiguration_feature",
						"_UI_InitialModel_type"),
				ExperimentsPackage.Literals.INITIAL_MODEL__SPD_SEMANTIC_CONFIGURATION, true, false, true, null, null,
				null));
	}
