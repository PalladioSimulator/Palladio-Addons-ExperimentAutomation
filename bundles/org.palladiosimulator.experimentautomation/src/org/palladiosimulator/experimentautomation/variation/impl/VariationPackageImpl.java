...
public class VariationPackageImpl extends EPackageImpl implements VariationPackage {
    ...
    public static VariationPackage init() {
        ...
        final Object registeredVariationPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        final VariationPackageImpl theVariationPackage = registeredVariationPackage instanceof VariationPackageImpl
    ...
    public EAttribute getVariationType_Name() {
        return (EAttribute) this.variationTypeEClass.getEStructuralFeatures()
            .get(0);
    }
    ...
    public EReference getVariationRepository_Variation() {
        return (EReference) this.variationRepositoryEClass.getEStructuralFeatures()
            .get(0);
    }
    ...
    public void initializePackageContents() {
        ...
        this.variationTypeEClass.getESuperTypes()
            .add(theIdentifierPackage.getIdentifier());
        this.valueVariationEClass.getESuperTypes()
            .add(this.getVariationType());
        this.structuralVariationEClass.getESuperTypes()
            .add(this.getVariationType());
