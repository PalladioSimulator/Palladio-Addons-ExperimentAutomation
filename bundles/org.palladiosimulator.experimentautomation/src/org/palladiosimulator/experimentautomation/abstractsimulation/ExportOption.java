...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>Export
 * Option</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 *
...
public enum ExportOption implements Enumerator {
    /**
     * The '<em><b>EDP2</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #EDP2_VALUE
     * @generated
     * @ordered
    ...
    /**
     * The '<em><b>CSV</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #CSV_VALUE
     * @generated
     * @ordered
    ...
    /**
     * The '<em><b>EDP2</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #EDP2
     * @model
     * @generated
    ...
    /**
     * The '<em><b>CSV</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #CSV
     * @model
     * @generated
    ...
    /**
     * An array of all the '<em><b>Export Option</b></em>' enumerators. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
     ...
     * @generated
     */
    public static ExportOption get(final String literal) {
        for (final ExportOption result : VALUES_ARRAY) {
            if (result.toString()
                .equals(literal)) {
                return result;
            }
     ...
     * @generated
     */
    public static ExportOption getByName(final String name) {
        for (final ExportOption result : VALUES_ARRAY) {
            if (result.getName()
                .equals(name)) {
                return result;
     ...
     * @generated
     */
    public static ExportOption get(final int value) {
        switch (value) {
        case EDP2_VALUE:
            return EDP2;
        case CSV_VALUE:
     ...
     * @generated
     */
    private ExportOption(final int value, final String name, final String literal) {
        this.value = value;
        this.name = name;
