 ...
 * @generated
 */
public class SlingshottooladapterSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static SlingshottooladapterPackage modelPackage;
	 ...
	 * @generated
	 */
	public SlingshottooladapterSwitch() {
		if (modelPackage == null) {
			modelPackage = SlingshottooladapterPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SlingshottooladapterPackage.SLINGSHOT_CONFIGURATION: {
				SlingshotConfiguration slingshotConfiguration = (SlingshotConfiguration)theEObject;
				T result = caseSlingshotConfiguration(slingshotConfiguration);
				if (result == null) result = caseAbstractSimulationConfiguration(slingshotConfiguration);
				if (result == null) result = caseToolConfiguration(slingshotConfiguration);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Slingshot Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Slingshot Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSlingshotConfiguration(SlingshotConfiguration object) {
		return null;
	}
